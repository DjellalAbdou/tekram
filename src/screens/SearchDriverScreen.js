...
class SearchDriverScreen extends Component {
  state = {
    text: "",
    drivers: []
  };
  ...
  onChangeText = text => {
    ...
    driverApi.getDriverByName(text, this.props.token, this);
  };
...
export default connect(mapStateToProps, null)(SearchDriverScreen);
